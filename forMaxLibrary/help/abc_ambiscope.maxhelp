...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 233.0, 186.25, 210.0, 208.0 ],
...
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "abc_ambiscope", "@obj-desc", "Visualization", "of", "an", "ambisonic", "field", "using", "Jitter", "for", "Max" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"embed" : 1,
...
, 							{
								"box" : 								{
									...
									"text" : "Visualization of an ambisonic field using Jitter for Max",
