...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 762.0, 326.0, 40.0, 22.0 ],
					"text" : "*~ 0.3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 983.0, 122.0, 82.0, 22.0 ],
					"text" : "loadmess 110"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 880.0, 122.0, 82.0, 22.0 ],
					"text" : "loadmess 110"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 762.0, 232.0, 60.0, 67.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1006.0, 165.5, 74.0, 33.0 ],
					"text" : "rev4 gain\n0 to 127"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 804.0, 165.5, 74.0, 47.0 ],
					"text" : "rev4 duration\n0 to 127"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 983.0, 326.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 880.0, 326.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 983.0, 174.0, 20.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 983.0, 368.0, 97.0, 22.0 ],
					"text" : "revGain $1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 880.0, 174.0, 20.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 880.0, 368.0, 61.0, 22.0 ],
					"text" : "revDur $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 880.0, 409.5, 231.0, 24.0 ],
					"text" : "abc_rev4quadri~",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 359.0, 160.5, 74.0, 33.0 ],
					"text" : "rev4 gain\n0 to 127"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 152.0, 160.5, 74.0, 47.0 ],
					"text" : "rev4 duration\n0 to 127"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 470.571441999999934, 87.0, 268.0, 127.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 599.571441999999934, 484.0, 45.0, 45.0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-68", 0 ],
					"midpoints" : [ 771.5, 402.5, 836.5, 402.5 ],
					"order" : 1,
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 771.5, 402.75, 889.5, 402.75 ],
					"order" : 0,
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-77", 0 ],
					"midpoints" : [ 992.5, 399.25, 889.5, 399.25 ],
					"source" : [ "obj-74", 0 ]
				}
