...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 109.857116000000133, 157.0, 79.0, 22.0 ],
									"text" : "127, 0 15000"
								}
...
,
					"patching_rect" : [ 676.5, 83.0, 81.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 676.5, 203.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 24.5, 203.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 24.5, 127.0, 117.0, 32.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 967.5, 456.0, 92.0, 89.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 967.5, 394.0, 166.0, 22.0 ],
					"text" : "abc_2d_scope7~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 1152.5, 455.0, 92.0, 89.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "signal", "list" ],
					"patching_rect" : [ 1152.0, 394.0, 166.0, 22.0 ],
					"text" : "abc_2d_scope7~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 317.5, 456.0, 92.0, 89.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "signal", "list" ],
					"patching_rect" : [ 317.5, 394.0, 104.714285714285779, 22.0 ],
					"text" : "abc_2d_scope3~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 380.5, 127.0, 248.0, 74.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 432.0, 455.0, 92.0, 89.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "signal", "list" ],
					"patching_rect" : [ 432.0, 394.0, 100.0, 22.0 ],
					"text" : "abc_2d_scope3~"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 686.0, 275.0, 826.5, 275.0 ],
					"source" : [ "obj-14", 0 ]
				}
