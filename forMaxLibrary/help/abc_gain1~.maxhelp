...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 388.0, 249.0, 83.0, 22.0 ],
					"text" : "/gains/gain $1"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 129.0, 180.0, 83.0, 22.0 ],
									"text" : "/gains/gain $1"
								}
...
,
					"patching_rect" : [ 15.5, 258.0, 77.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 474.0, 103.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 474.0, 127.0, 43.0, 22.0 ],
					"text" : "freq 7."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 94.499999999999986, 430.0, 164.0, 26.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 498.0, 430.0, 164.0, 26.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 498.699999999999989, 233.0, 196.955555555555463, 22.0 ],
					"text" : "abc_randenv16~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 17,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "signal", "list" ],
					"patching_rect" : [ 499.64285714285711, 178.5, 207.65881969881957, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 6.0, 478.0, 548.0, 23.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 235.0, 277.0, 98.0, 60.0 ],
					"text" : "abc_gain1~, abc_gain2~, ... provide n gain controls in dB"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 94.499999999999986, 103.0, 210.0, 31.0 ],
					"viewvisibility" : 1
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 103.999999999999986, 372.5, 249.0, 372.5 ],
					"order" : 0,
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-16", 0 ],
					"hidden" : 1,
					"midpoints" : [ 483.5, 216.25, 508.199999999999989, 216.25 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-10", 0 ],
					"midpoints" : [ 25.0, 287.5, 103.999999999999986, 287.5 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 586.25, 416.5, 652.5, 416.5 ],
					"source" : [ "obj-5", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 25.0, 255.75, 25.0, 255.75 ],
					"source" : [ "obj-55", 0 ]
				}
