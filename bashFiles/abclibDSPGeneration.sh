...
chmod +x optim3dFaustCodeGeneration.sh
...
chmod +x scopes3dFaustCodeGeneration.sh
...
chmod +x vectors3dFaustCodeGeneration.sh 
...
./optim3dFaustCodeGeneration.sh $amb3dorder
...
./scopes3dFaustCodeGeneration.sh $amb3dorder
...
./vectors3dFaustCodeGeneration.sh $amb3dorder
