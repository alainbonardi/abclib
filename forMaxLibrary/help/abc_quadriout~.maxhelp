...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 252.0, 212.0, 150.0, 114.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 243.0, 110.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "signal", "signal", "signal", "signal", "list" ],
					"patching_rect" : [ 50.0, 201.75, 140.333333333333485, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "signal", "signal", "signal", "signal", "list" ],
					"patching_rect" : [ 50.0, 164.0, 180.777777777778738, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 50.0, 320.0, 185.0, 32.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "abc_quadriout", "@obj-desc", 4, "channel", "output", "with", "amplitude", "control", "in", "dB" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"embed" : 1,
