...
,
					"patching_rect" : [ 692.5, 446.5, 77.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 30.0, 565.0, 164.0, 26.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 478.0, 565.0, 164.0, 26.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 216.0, 544.0, 233.0, 47.0 ],
					"text" : "- gain is the output gain in dB\n- directangles is 1 for anticlockwise (as in ambisonic norm) and 0 for clockwise"
				}

			}
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "abc_stereodecoderN~", "@obj-desc", "Ambisonic", "stereo", "decoders" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 108.5, 548.5, 184.5, 548.5 ],
					"source" : [ "obj-2", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 1 ],
					"midpoints" : [ 580.0, 546.5, 632.5, 546.5 ],
					"source" : [ "obj-20", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-20", 0 ],
					"midpoints" : [ 702.0, 482.75, 487.5, 482.75 ],
					"source" : [ "obj-7", 0 ]
				}
