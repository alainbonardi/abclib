...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 104.0, -123.0, 96.0, 22.0 ],
					"text" : "route rarefaction"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 5.0, -123.0, 87.0, 22.0 ],
					"text" : "route grainsize"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 19.0, -197.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 212.0, -119.0, 62.0, 22.0 ],
					"text" : "route gain"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 19.0, -167.0, 72.0, 22.0 ],
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 4.0, -29.0, 29.5, 22.0 ],
					"text" : "t f b"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 428.712872564792633, 58.41584175825119, 29.5, 22.0 ],
					"text" : "t b f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 428.712872564792633, 105.000000298023224, 29.5, 22.0 ],
					"text" : "/ 1."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 414.712872564792633, 31.683168411254883, 61.0, 22.0 ],
					"text" : "dspstate~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 212.0, 205.0, 39.0, 22.0 ],
					"text" : "$1 20"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 212.0, 242.0, 51.0, 22.0 ],
					"text" : "line~ 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 289.0, 170.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 289.0, 209.0, 45.0, 22.0 ],
					"text" : "310 30"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 289.0, 252.0, 117.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 13.5, 81.103960514068604, 438.212872564792633, 81.103960514068604 ],
					"order" : 0,
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 24.0, -4.658415794372559, 424.212872564792633, -4.658415794372559 ],
					"source" : [ "obj-30", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 81.5, -134.5, 14.5, -134.5 ],
					"order" : 2,
					"source" : [ "obj-37", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 81.5, -127.5, 113.5, -127.5 ],
					"order" : 1,
					"source" : [ "obj-37", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 438.212872564792633, 280.232673645019531, 76.5, 280.232673645019531 ],
					"source" : [ "obj-40", 0 ]
				}
