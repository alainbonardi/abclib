...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 715.0, 559.0, 92.5, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 105.0, 559.0, 74.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "abc_encoder1~", "to", "abc_encoder7~", "@obj-desc", "Ambisonic", "encoders", "at", "orders", 1, "from", 7 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
