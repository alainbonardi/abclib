...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 184.5, 263.0, 122.5, 22.0 ],
					"text" : "mc.combine~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 136.321441999999934, 98.5, 38.821442000000062, 20.0 ],
					"text" : "Gain"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 134.321441999999934, 98.5, 40.821442000000062, 20.0 ],
					"proportion" : 0.5,
					"rounded" : 10
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 111.321441999999934, 98.5, 23.0, 23.0 ],
					"text" : "2",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 107.321441999999934, 96.5, 23.0, 25.0 ],
					"proportion" : 0.5,
					"shape" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 529.321441999999934, 425.75, 49.0, 20.0 ],
					"text" : "Turn on"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 503.321441999999934, 424.75, 23.0, 23.0 ],
					"text" : "1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 499.321441999999934, 422.75, 23.0, 25.0 ],
					"proportion" : 0.5,
					"shape" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 529.321441999999934, 425.75, 54.0, 20.0 ],
					"proportion" : 0.5,
					"rounded" : 10
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 410.5, 263.0, 150.0, 47.0 ],
					"text" : "it generates the polar coordinates of the source\nr and theta (in radians)"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 23.0, 254.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 23.0, 286.5, 90.0, 22.0 ],
					"text" : "directangles $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 515.5, 449.75, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 410.5, 136.0, 150.0, 100.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 367.0, 389.0, 90.0, 110.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 367.5, 356.0, 104.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 118.0, 254.5, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 118.0, 286.5, 59.0, 22.0 ],
					"text" : "stereo $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 184.5, 376.5, 134.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 184.5, 345.0, 115.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 105.0, 126.0, 75.0, 110.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 184.5, 298.0, 95.0, 22.0 ],
					"text" : "abc.hoa.map~ 3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 410.5, 88.0, 22.0, 20.0 ],
					"text" : "y"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 329.5, 88.0, 22.0, 20.0 ],
					"text" : "x"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 428.5, 88.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 346.5, 88.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 288.0, 88.0, 35.0, 22.0 ],
					"text" : "reset"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 288.0, 126.0, 105.0, 130.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 184.5, 223.0, 94.0, 22.0 ],
					"text" : "abc.soundcoat~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 6.0, 505.0, 325.499999999999773, 33.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "abc.pict2map", "@obj-desc", "Graphic", "2D", "control", "of", "a", "source", "position" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"embed" : 1,
...
, 							{
								"box" : 								{
									...
									"text" : "Graphic 2D control of a source position",
...
,
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 32.5, 332.0, 290.0, 332.0 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 438.0, 122.5, 383.5, 122.5 ],
					"source" : [ "obj-27", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 194.0, 325.5, 377.0, 325.5 ],
					"order" : 0,
					"source" : [ "obj-30", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 1 ],
					"midpoints" : [ 114.5, 331.25, 290.0, 331.25 ],
					"source" : [ "obj-31", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 1 ],
					"midpoints" : [ 127.5, 332.0, 290.0, 332.0 ],
					"source" : [ "obj-44", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-42", 0 ],
					"midpoints" : [ 356.0, 122.5, 297.5, 122.5 ],
					"source" : [ "obj-52", 0 ]
				}
