...
,
					"patching_rect" : [ 317.0, 481.0, 71.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 153.0, 447.0, 159.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 10.0, 475.0, 330.0, 39.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "abc.simplefmburst~", "@obj-desc", "Simple", "and", "short", "(110", "milliseconds)", "FM", "synthesis" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"embed" : 1,
...
, 							{
								"box" : 								{
									...
									"text" : "Simple and short (110 milliseconds) FM synthesis",
