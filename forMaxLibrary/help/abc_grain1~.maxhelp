...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 457.0, 387.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 457.0, 419.0, 90.0, 22.0 ],
					"text" : "directangles $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 558.0, 502.0, 5.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 212.821441999999934, 231.5, 45.0, 22.0 ],
					"text" : "gain 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 691.5, 316.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 575.0, 200.0, 156.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 691.5, 387.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 691.5, 419.0, 59.0, 22.0 ],
					"text" : "stereo $1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 575.0, 463.5, 118.428571428571331, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 597.5, 320.5, 45.0, 22.0 ],
					"text" : "r gctrl2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 8,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "list" ],
					"patching_rect" : [ 575.0, 354.5, 134.999999999999773, 24.0 ],
					"text" : "abc_grain7~"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 466.5, 451.75, 584.5, 451.75 ],
					"source" : [ "obj-21", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 607.0, 348.0, 584.5, 348.0 ],
					"source" : [ "obj-45", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-54", 0 ],
					"midpoints" : [ 701.0, 455.25, 584.5, 455.25 ],
					"source" : [ "obj-48", 0 ]
				}
