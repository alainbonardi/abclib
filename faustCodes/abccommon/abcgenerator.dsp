...
noisepulseratio = hslider("v:generator/h:noise/noisepulseratio", 1, 0, 10, 0.01);
//
...
sinuspulseratio = hslider("v:generator/h:sinus/sinuspulseratio", 1, 0, 10, 0.01);
//
...
phasorpulseratio = hslider("v:generator/h:phasor/phasorpulseratio", 1, 0, 10, 0.01);
//
//--------------------------------------------------------------------------------------//
