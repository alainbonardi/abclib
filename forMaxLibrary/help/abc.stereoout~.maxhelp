...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 447.0, 423.0, 49.0, 20.0 ],
					"text" : "Turn on"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 421.0, 422.0, 23.0, 23.0 ],
					"text" : "1",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 417.0, 420.0, 23.0, 25.0 ],
					"proportion" : 0.5,
					"shape" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 447.0, 423.0, 54.0, 20.0 ],
					"proportion" : 0.5,
					"rounded" : 10
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 509.0, 411.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 48.0, 304.0, 185.0, 26.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 254.0, 196.0, 150.0, 114.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 48.0, 227.0, 110.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "signal", "list" ],
					"patching_rect" : [ 48.0, 148.0, 201.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 6.0, 470.0, 333.0, 39.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "abc_stereoout", "@obj-desc", 2, "channel", "output", "with", "amplitude", "control", "in", "dB" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"embed" : 1,
...
, 							{
								"box" : 								{
									...
									"text" : "2 channel output with amplitude control in dB",
...
,
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 103.0, 276.0, 223.5, 276.0 ],
					"source" : [ "obj-71", 1 ]
				}
