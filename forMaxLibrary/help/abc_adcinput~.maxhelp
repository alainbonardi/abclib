...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 135.0, 233.0, 39.0, 22.0 ],
					"text" : "r del1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 110.0, 271.0, 77.0, 22.0 ],
					"text" : "abc_delay1~"
				}
...
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "abc_adcinput~", "@obj-desc", "Mono", "adc~", "input", "with", "possible", "dc", "filtering" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"embed" : 1,
