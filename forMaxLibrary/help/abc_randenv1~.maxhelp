...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 299.0, 191.0, 131.0, 22.0 ],
					"text" : "/randenv/shortening $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 195.0, 191.0, 96.0, 22.0 ],
					"text" : "/randenv/freq $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 141.5, 437.0, 72.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 141.5, 369.0, 125.0, 22.0 ],
...
,
					"patching_rect" : [ 53.571441999999934, 316.5, 77.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 53.571441999999934, 237.0, 73.0, 72.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1237.0, 135.0, 131.0, 22.0 ],
					"text" : "/randenv/shortening $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1133.0, 135.0, 96.0, 22.0 ],
					"text" : "/randenv/freq $1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 810.571441999999934, 583.0, 164.133333333333894, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 355.0, 402.0, 79.0, 22.0 ],
					"text" : "loadmess 64"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 355.0, 370.0, 79.0, 22.0 ],
					"text" : "loadmess 96"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 273.5, 457.5, 50.0, 49.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "signal", "signal", "list" ],
					"patching_rect" : [ 274.0, 369.0, 80.0, 22.0 ],
					"text" : "abc_scope1~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 470.571441999999934, 87.0, 263.0, 194.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-66", 0 ],
					"midpoints" : [ 63.071441999999934, 358.5, 151.0, 358.5 ],
					"source" : [ "obj-62", 0 ]
				}
