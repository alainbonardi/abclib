...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 163.0, 356.0, 165.0, 47.0 ],
									"presentation_linecount" : 3,
									"text" : "you can control that with headtracker like your phone\n(ex: Sensors2OSC) "
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "float" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 117.0, 356.0, 44.0, 48.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 117.0, 411.0, 55.0, 22.0 ],
									"text" : "angle $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 259.0, 280.0, 39.0, 22.0 ],
									"text" : "a1 $1"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 34.0, 442.0, 102.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 42.5, 525.0, 81.0, 22.0 ],
									"text" : "loadmess -99"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 329.0, 392.0, 30.0, 30.0 ]
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 329.0, 276.0, 40.0, 22.0 ],
													"text" : "* 180."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "float" ],
													"patching_rect" : [ 329.0, 242.0, 59.0, 22.0 ],
													"text" : "/ 3.14159"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "bang" ],
													"patching_rect" : [ 269.0, 174.0, 22.0, 22.0 ],
													"text" : "t b"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 5,
													"outlettype" : [ "", "", "", "", "" ],
													"patching_rect" : [ 224.0, 148.0, 109.0, 22.0 ],
													"text" : "regexp /circle/2/pol"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 329.0, 205.0, 72.0, 22.0 ],
													"text" : "4.712389"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 124.0, 298.5, 50.0, 22.0 ],
													"text" : "270."
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "bang" ],
													"patching_rect" : [ 95.0, 154.0, 22.0, 22.0 ],
													"text" : "t b"
												}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 216.0, 280.0, 39.0, 22.0 ],
									"text" : "a0 $1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 34.0, 312.0, 201.0, 35.0 ],
									"text" : "abc.hoa.encoder~ 3 @dimensions 2 @sources 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 34.0, 485.0, 247.0, 24.0 ],
									"text" : "abc.hoa.binaural~ 3 @dimensions 2",
...
, 							{
								"box" : 								{
									"args" : [ "@obj-name", "abc.hoa.binaural~", "@obj-desc", "Ambisonic", "binaural", "decoders", "at", "orders", 1, "to", 5 ],
									"bgmode" : 0,
									"border" : 0,
									"clickthrough" : 0,
									"enablehscroll" : 0,
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 426.5, 525.0, 347.5, 525.0, 347.5, 269.0, 268.5, 269.0 ],
									"source" : [ "obj-53", 1 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 360.5, 525.0, 347.5, 525.0, 347.5, 258.0, 225.5, 258.0 ],
									"source" : [ "obj-53", 0 ]
								}
...
,
					"patching_rect" : [ 29.0, 207.0, 88.0, 22.0 ],
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-4::obj-4" : [ "mc.live.gain~[2]", "mc.live.gain~", 0 ],
			"obj-4::obj-41" : [ "live.dial[7]", "yaw", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
...
, 			{
				"name" : "abc_2d_multiencoder3_2~.mxo",
				"type" : "iLaX"
			}
, 			{
