...
gain = hslider("v:SubstractSynth/h:General/gain [unit:dB]", -10, -127, 18, 0.01) : smoothLine : dbcontrol;
...
amp(ind) = hslider("v:SubstractSynth/h:Partials/v:Gains/amp%2ind", (ba.linear2db(1/(ind+1))), -127, 18, 0.01) : smoothLine : dbcontrol;
//--------------------------------------------------------------------------------------//
