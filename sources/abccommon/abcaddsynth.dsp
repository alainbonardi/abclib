...
gain = hslider("v:AddSynth/h:General/gain [unit:dB]", 0, -127, 18, 0.01) : smoothLine : dbcontrol;
...
fmult(ind) = nentry("v:AddSynth/h:Partials/v:Frequencies/fmult%2ind", (ind+1), 0, 1000, 0.00001);
