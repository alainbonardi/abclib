...
___________________________
After decompressing the 'abclib_puredata_universal_faustgen' folder, you will get a folder 'abclib' you should copy to the externals folder.
Then you should add the path in the preferences panel of Pure Data, in the 'Path' window.
...
You can use any of the .dsp codes inside your Pure Data patch.

In the same folder, you will find various abstractions and a lot of tutorials. There are no real help patches, since asking for it by clicking on pd-faustgen displays the pd-faustgen help patch.
