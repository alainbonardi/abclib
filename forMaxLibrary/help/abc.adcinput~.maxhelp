...
,
					"patching_rect" : [ 22.0, 30.0, 25.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 437.0, 203.0, 97.0, 22.0 ],
									"text" : "abc.comment.bg"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 329.0, 235.0, 205.0, 74.0 ],
									"text" : "@channel is the number of the channel (adc)\n@gain is the amplitude in dB\n@dc-filter is the enabling (1/0) of the dc filtering"
								}

							}
, 							{
								"box" : 								{
									"args" : [ "@name", "abc.adcinput~" ],
									"bgmode" : 0,
									"border" : 0,
									"clickthrough" : 0,
									"enablehscroll" : 0,
									...
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 2.5, 59.0, 485.0, 40.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									"args" : [ "@obj-name", "abc.adcinput~", "@obj-desc", "Mono", "adc~", "input", "with", "possible", "dc", "filtering" ],
									"bgmode" : 0,
									"border" : 0,
									"clickthrough" : 0,
									"embed" : 1,
...
, 											{
												"box" : 												{
													...
													"text" : "Mono adc~ input with possible dc filtering",
...
,
									"patching_rect" : [ 2.5, 4.0, 485.0, 61.0 ],
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 90.0, 436.5, 49.0, 20.0 ],
									"text" : "Turn on"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 65.0, 435.0, 23.0, 23.0 ],
									"text" : "1",
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 61.0, 433.0, 23.0, 25.0 ],
									"proportion" : 0.5,
									"shape" : 1
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 159.0, 334.0, 5.0, 100.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 329.0, 323.0, 58.0, 22.0 ],
									"text" : "loadbang"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 187.0, 235.0, 39.0, 22.0 ],
									"text" : "r del1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "float", "int" ],
									"patching_rect" : [ 38.0, 334.0, 5.0, 100.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 110.0, 271.0, 96.0, 22.0 ],
									"text" : "abc.mc.delay~ 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 111.0, 148.0, 41.0, 20.0 ],
									"text" : "on/off"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 84.0, 146.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 2,
									"numoutlets" : 0,
									"patching_rect" : [ 84.0, 389.0, 45.0, 45.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"offset" : [ 0.0, 0.0 ],
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 84.0, 177.0, 322.0, 42.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 0,
									"offset" : [ 0.0, 0.0 ],
									"patching_rect" : [ 6.0, 470.0, 334.0, 40.0 ],
									"presentation" : 1,
...
,
					"patching_rect" : [ 11.0, 6.0, 94.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
		...
		"lines" : [  ],
		"parameters" : 		{
			"obj-17::obj-8::obj-2" : [ "live.gain~[1]", "live.gain~", 0 ],
			"parameterbanks" : 			{
