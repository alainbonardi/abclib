...
,
		"classnamespace" : "box",
		"rect" : [ 1024.0, 557.0, 1370.0, 743.0 ],
		"bglocked" : 0,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 891.0, 146.0, 187.0, 22.0 ],
					"text" : "abc_addsynth16~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 599.0, 253.0, 164.0, 328.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 728.5, 93.5, 82.0, 72.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 898.0, 307.0, 69.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 886.0, 215.0, 176.5, 24.0 ],
					"text" : "abc_chopan16~",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 45.0, 321.0, 62.5, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "abc_addchopan1~", "to", "abc_chopan16~", "@obj-desc", "Chowning", "panners" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
