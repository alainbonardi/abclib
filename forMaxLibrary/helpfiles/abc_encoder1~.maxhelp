...
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "abc_encoder1~", "@obj-desc", "An", "ambisonic", "encoder", "at", "order", 1 ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"enablehscroll" : 0,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 105.0, 584.0, 45.0, 45.0 ]
				}
