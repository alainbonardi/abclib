...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 614.571441999999934, 110.0, 47.0, 20.0 ],
					"text" : "Control"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 610.571441999999934, 110.0, 51.0, 20.0 ],
					"proportion" : 0.5,
					"rounded" : 10
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 587.571441999999934, 110.0, 23.0, 23.0 ],
					"text" : "3",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 583.571441999999934, 108.0, 23.0, 25.0 ],
					"proportion" : 0.5,
					"shape" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 48.321441999999934, 249.5, 38.821442000000062, 20.0 ],
					"text" : "Gain"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 46.321441999999934, 249.5, 40.821442000000062, 20.0 ],
					"proportion" : 0.5,
					"rounded" : 10
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 23.321441999999934, 249.5, 23.0, 23.0 ],
					"text" : "2",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 19.321441999999934, 247.5, 23.0, 25.0 ],
					"proportion" : 0.5,
					"shape" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 568.0, 385.0, 49.0, 20.0 ],
					"text" : "Turn on"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 541.0, 385.0, 23.0, 23.0 ],
					"text" : "1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 537.0, 383.0, 23.0, 25.0 ],
					"proportion" : 0.5,
					"shape" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 566.0, 385.0, 54.0, 20.0 ],
					"proportion" : 0.5,
					"rounded" : 10
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 19.0, 276.0, 75.0, 110.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 104.25, 405.5, 90.0, 22.0 ],
					"text" : "abc.mc.gain~ 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 681.0, 226.5, 289.0, 22.0 ],
					"text" : "http://lib.tkk.fi/Diss/2001/isbn9512255324/article1.pdf",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 276.0, 101.0, 97.0, 20.0 ],
					"text" : "rotation or static"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 246.5, 101.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 246.5, 239.0, 32.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 260.0, 203.0, 82.0, 22.0 ],
					"text" : "peakamp~ 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 260.0, 176.0, 44.0, 22.0 ],
					"text" : "*~ 360"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 260.0, 146.0, 72.0, 22.0 ],
					"text" : "phasor~ 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 104.0, 449.0, 190.0, 33.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 246.5, 273.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 128.0, 315.5, 49.0, 22.0 ],
					"text" : "r vbap4"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 599.880961333333175, 171.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 544.190480666666531, 171.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 489.309519333333242, 171.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 434.309519333333242, 330.0, 51.0, 22.0 ],
					"text" : "s vbap4"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 434.309519333333242, 171.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 434.309519333333242, 135.5, 101.0, 22.0 ],
					"text" : "unpack 0. 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 246.5, 308.0, 52.0, 22.0 ],
					"text" : "theta $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 104.25, 362.5, 89.0, 24.0 ],
					"text" : "abc.vbap~ 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 104.25, 101.0, 94.0, 22.0 ],
					"text" : "abc.soundcoat~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 549.190480666666645, 409.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 6.0, 509.0, 336.0, 39.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "abc.vbap~ object provide implementations of VBAP algorithm  by Ville Pulkki for various number of loudspeakers dispatched on a circle with angles that can be irregular."
				}

			}
, 			{
				"box" : 				{
					"args" : [ "@obj-name", "abc.vbap~", "@obj-desc", "A", "circular", "VBAP", "spatialization", "with", "irregular", "angles" ],
					"bgmode" : 0,
					"border" : 0,
					"clickthrough" : 0,
					"embed" : 1,
...
, 							{
								"box" : 								{
									...
									"text" : "A circular VBAP spatialization with irregular angles",
...
, 			{
				"patchline" : 				{
					...
					"hidden" : 1,
					"midpoints" : [ 690.5, 258.5, 866.0, 258.5, 866.0, 235.5, 1152.5, 235.5 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 1 ],
					"midpoints" : [ 256.0, 353.75, 183.75, 353.75 ],
					"source" : [ "obj-19", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-29", 0 ],
					"midpoints" : [ 609.380961333333175, 312.75, 443.809519333333242, 312.75 ],
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-29", 0 ],
					"midpoints" : [ 553.690480666666531, 292.75, 443.809519333333242, 292.75 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-29", 0 ],
					"midpoints" : [ 498.809519333333242, 279.25, 443.809519333333242, 279.25 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 525.809519333333242, 163.75, 609.380961333333175, 163.75 ],
					"source" : [ "obj-34", 3 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 498.476185999999871, 163.75, 553.690480666666531, 163.75 ],
					"source" : [ "obj-34", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 471.142852666666556, 163.75, 498.809519333333242, 163.75 ],
					"source" : [ "obj-34", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 1 ],
					"midpoints" : [ 137.5, 353.25, 183.75, 353.25 ],
					"source" : [ "obj-37", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 28.5, 394.75, 184.75, 394.75 ],
					"source" : [ "obj-53", 0 ]
				}
